...
prepAdherence2020 = [0.024096386 0.22265060 0.75325301];
...
for t = 1:T
    ...
    if ismember(t, yr_prep_init) && prep_init_flg
       prepOn_transition_path = file_common_part + 'input/transitions/prepOn_transition2020.csv';
    end
    if ismember(t, yr_prep_dis) && prep_dis_flg
       prepOff_transition_path = file_common_part + 'input/transitions/prepOff_transition2020.csv';
       prepAdherence = prepAdherence2020;
    else
    ...
    if ismember(t, yr_vls) && vls_flg
       treatmentOn_transition_path = file_common_part + 'input/transitions/treatmentOn_transition2020.csv';
    else
