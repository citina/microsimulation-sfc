...
prepAdherence_best = [0.024096386 0.12751807 0.84838554];
...
for t = 1:T
    ...
    if ismember(t, yr_prep_init) && prep_init_flg
       prepOn_transition_path = file_common_part + 'input/transitions/prepOn_transition_best.csv';
    end
    if ismember(t, yr_prep_dis) && prep_dis_flg
       prepOff_transition_path = file_common_part + 'input/transitions/prepOff_transition_best.csv';
       prepAdherence = prepAdherence_best;
    else
    ...
    if ismember(t, yr_vls) && vls_flg
       treatmentOn_transition_path = file_common_part + 'input/transitions/treatmentOn_transition_best.csv';
    else
